...
class CodeGeneratorRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CodeGeneratorRequest')
    ...
    ..pp(15, 'protoFile', PbFieldType.PM, google$protobuf.FileDescriptorProto.$checkItem, google$protobuf.FileDescriptorProto.create)
  ;
  ...
  List<google$protobuf.FileDescriptorProto> get protoFile => $_get(2, 15, null);
}
...
const CodeGeneratorRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proto_file', '3': 15, '4': 3, '5': 11, '6': '.google.protobuf.FileDescriptorProto'},
  ],
};
...
const CodeGeneratorResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'file', '3': 15, '4': 3, '5': 11, '6': '.google.protobuf.compiler.CodeGeneratorResponse.File'},
  ],
